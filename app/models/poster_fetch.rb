...
class PosterFetch
  ...
  # To grab just the first provided photo sans restrictions, call @fetcher.fetch_links("jupiter").
  ...
  def pluck_jpgs(urls, amount, width, height)
    ...
    add_sources(urls) # sets hash keys as image sources
  end

  # checks against the default settings
